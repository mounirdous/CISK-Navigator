...
class ExcelExportService:
    ...
    def _write_space(ws, space, value_types, start_row):
        ...
        cell.fill = PatternFill(start_color=ExcelExportService.COLOR_SPACE,
                               end_color=ExcelExportService.COLOR_SPACE, fill_type='solid')
    ...
    def _write_challenge(ws, challenge, value_types, start_row):
        ...
        cell.fill = PatternFill(start_color=ExcelExportService.COLOR_CHALLENGE,
                               end_color=ExcelExportService.COLOR_CHALLENGE, fill_type='solid')
    ...
    def _write_initiative(ws, initiative, value_types, start_row):
        ...
        cell.fill = PatternFill(start_color=ExcelExportService.COLOR_INITIATIVE,
                               end_color=ExcelExportService.COLOR_INITIATIVE, fill_type='solid')
    ...
    def _write_system(ws, sys_link, value_types, start_row):
        ...
        cell.fill = PatternFill(start_color=ExcelExportService.COLOR_SYSTEM,
                               end_color=ExcelExportService.COLOR_SYSTEM, fill_type='solid')
    ...
    def _write_kpi(ws, kpi, value_types, row):
        ...
        cell.fill = PatternFill(start_color=ExcelExportService.COLOR_KPI,
                               end_color=ExcelExportService.COLOR_KPI, fill_type='solid')
