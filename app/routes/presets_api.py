...
VALID_FEATURES = {"workspace", "action_items", "search", "pivot", "decisions", "kpi_dashboard", "challenges_dashboard", "systems_dashboard", "visibility_dashboard"}
...
def get_presets():
    ...
    if feature in ("workspace", "action_items", "decisions", "kpi_dashboard", "challenges_dashboard", "systems_dashboard", "visibility_dashboard"):
        presets = (
