...
class ValueTypeCreateForm(FlaskForm):
    ...
    color_positive = StringField('Positive Value Color', default='#28a745', validators=[Optional(), Length(max=7)])
    color_zero = StringField('Zero/Null Value Color', default='#6c757d', validators=[Optional(), Length(max=7)])
    color_negative = StringField('Negative Value Color', default='#dc3545', validators=[Optional(), Length(max=7)])
...
class ValueTypeEditForm(FlaskForm):
    ...
    unit_label = StringField('Unit Label (e.g., €, tCO2e)', validators=[Optional(), Length(max=50)])
    color_positive = StringField('Positive Value Color', validators=[Optional(), Length(max=7)])
    color_zero = StringField('Zero/Null Value Color', validators=[Optional(), Length(max=7)])
    color_negative = StringField('Negative Value Color', validators=[Optional(), Length(max=7)])
