...
**Version 2.5.3** - Enhanced with multi-links, priorities, weights, interactive graph view, dual version display, analytics tracking, customizable colors, full mobile/desktop zoom support, and tooltips
