...
def test_login_valid_credentials(client, regular_user, organization):
    ...
    response = client.post(
        "/auth/login",
        data={"login": "testuser", "password": "TestPass123", "organization": organization.id},
...
def test_login_invalid_password(client, regular_user, organization):
    ...
    response = client.post(
        "/auth/login", data={"login": "testuser", "password": "WrongPassword", "organization": organization.id}
    )
...
def test_login_inactive_user(client, regular_user, organization):
    ...
    response = client.post(
        "/auth/login", data={"login": "testuser", "password": "TestPass123", "organization": organization.id}
    )
...
def test_global_admin_login_to_global_administration(client, global_admin):
    ...
    response = client.post(
        "/auth/login",
        data={"login": "testadmin", "password": "TestPass123", "organization": 0},  # 0 = Global Administration
        follow_redirects=True,
    )
...
def test_regular_user_cannot_login_to_global_administration(client, regular_user):
    ...
    response = client.post(
        "/auth/login",
        data={"login": "testuser", "password": "TestPass123", "organization": 0},  # 0 = Global Administration
    )
...
def test_user_cannot_login_to_unassigned_organization(client, regular_user):
    ...
    response = client.post(
        "/auth/login", data={"login": "testuser", "password": "TestPass123", "organization": other_org_id}
    )
...
def test_password_change(client, regular_user, organization):
    ...
    # Login
    client.post("/auth/login", data={"login": "testuser", "password": "TestPass123", "organization": organization.id})
